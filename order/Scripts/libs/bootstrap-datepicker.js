...
(function ($) {
    ...
    Datepicker.prototype = {
        ...
        show: function (e) {
            if (!this.isInline)
                this.picker.appendTo('.datepicker-wrapper');
            this.picker.show();
        ...
        place: function () {
            ...
            if (yorient === 'top')
                ...
                top = $('.datepicker-wrapper input').height();
    ...
    DPGlobal.template = '<div class="datepicker">' +
							'<div class="datepicker-days">' +
								'<table class=" table-condensed table-header">' +
									DPGlobal.headTemplate +
								'</table>'+'<table class=" table-condensed">'+'<tbody></tbody>' +
